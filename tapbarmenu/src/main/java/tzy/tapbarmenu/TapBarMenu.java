...
public class TapBarMenu extends LinearLayout {
  ...
  private void setupAttributes(AttributeSet attrs) {
    ...
    backgroundColor = typedArray.getColor(R.styleable.TapBarMenu_tbm_backgroundColor, getResources().getColor(R.color.red));
    buttonSize =
  ...
  public void setMenuBackgroundColor(int colorResId) {
    backgroundColor = getResources().getColor(colorResId);
    paint.setColor(backgroundColor);
    invalidate();
  }
