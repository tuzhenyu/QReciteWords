 ...
 */
public class UncaseAlphatIndexer  extends DataSetObserver {
     ...
     */
    public UncaseAlphatIndexer(Cursor cursor, int sortedColumnIndex, CharSequence alphabet) {
        mDataCursor = cursor;
    ...
    protected int compare(String word, String letter) {
        ...
        if (word.length() == 0) {
            ...
            firstLetter = Character.toString(Character.toUpperCase(word.charAt(0)));
            letter = Character.toString(Character.toUpperCase(letter.charAt(0)));
        }
