...
public class ColorDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contentView = (ViewGroup) View.inflate(getContext(), R.layout.layout_colordialog, null);
    ...
    public void replaceView(int index , View view){
        ViewGroup viewGroup = (ViewGroup) mBkgView;
        viewGroup.removeViewAt(index);
        viewGroup.addView(view,index);
    }

    public void setCcontentView(View view){
        int index = 1;
